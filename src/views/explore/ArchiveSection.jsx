...
export default function ArchiveSection({
  ...
  const hint = !isFiled
    ...
    : "Choose Theme, Year, or Type to regroup. Tap a folder to pull its reports into a carousel; use the arrows or keys to browse, and tap the featured report to open it. The sidebar list has every report.";
